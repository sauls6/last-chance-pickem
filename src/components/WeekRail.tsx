    ...
    <div className="w-full overflow-hidden py-2">
      ...
      >
        {weeks.map((wk) => {
          ...
          const isFinal = wk < currentNflWeek;
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 flex flex-col items-center justify-center min-w-[76px] py-2 px-3 rounded-xl border transition-all duration-200 cursor-pointer ${
                isSelected
